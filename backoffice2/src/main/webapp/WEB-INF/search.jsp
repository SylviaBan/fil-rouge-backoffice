    ...
    <div class="card mt-3 text-grey">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-end">
          <button type="button" class="btn btn-info my-btn-position">
            <span class="material-symbols-outlined">Edit</span>
          </button>
          <form action="delete" method="POST">
            <button type="submit" class="btn btn-danger my-btn-position mx-1" onclick="confirmDelete(${user.getId()})">
              <span class="material-symbols-outlined">Delete</span>
            </button>
            <!-- Un champ caché pour transmettre l'ID de l'utilisateur -->
            <input type="hidden" name="id" value="${user.getId()}">
          </form>
          <button type="button" class="btn btn-success my-btn-position mx-1">
            <span class="material-symbols-outlined">Activate</span>
          </button>
          <button type="button" class="btn btn-secondary my-btn-position mx-1">
